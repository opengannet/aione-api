	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.GET("/token", middleware.DisableCache(), controller.GetAccessToken)
		...
		tokenRoute.Use(middleware.UserAuth())
		{
			...
			tokenRoute.POST("/flyte-publication", middleware.DisableCache(), controller.AddFlytePublicationToken)
		...
		deploymentsRoute.Use(middleware.AdminAuth())
		{
			...
			deploymentsRoute.PUT("/settings", controller.UpdateModelDeploymentSettings)
			deploymentsRoute.POST("/settings/test-connection", controller.TestFlyte2Connection)
			...
			deploymentsRoute.POST("/:id/publication/bindings", controller.AddDeploymentPublicationBindings)
			deploymentsRoute.DELETE("/:id/publication/bindings/:token_id", controller.DeleteDeploymentPublicationBinding)
			deploymentsRoute.PUT("/:id/publication/upstream-model", controller.UpdateDeploymentPublicationUpstreamModel)
			deploymentsRoute.POST("/:id/publication/reconcile", controller.ReconcileDeploymentPublication)
